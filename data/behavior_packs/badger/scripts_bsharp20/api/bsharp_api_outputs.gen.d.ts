 ...
 */
declare function OUTPUT_PlacementPreferBiomeRule(biomeNames: string[]): void
...
/**
 * Sets a spawners (barracks and player cages for now) add tags which will be added to their spawned entities.
 *
 * @param entities The spawner entities to update
 * @param tags The tags to add to the spawned entities.
 */
declare function OUTPUT_SetSpawnerAddTags(entities: number[], tags: string[]): void
