...
/**
 * Reduces a global variable value by 1.
 *
 * @param variable The global variable key.
 */
declare function DecrementGlobal(variable: string): void
...
/**
 * Increment a global variable by one.
 *
 * @param variable The global variable name.
 */
declare function IncrementGlobal(variable: string): void
 ...
 * 
 */
declare function GetOutpostDifficultyFromPhase(): number
