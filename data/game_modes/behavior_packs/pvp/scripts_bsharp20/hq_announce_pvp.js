const pvpAnnouncerVal = {
    ...
    structureListeners: [
        ...
        {
            tag: "increase_lure_cap", // Increase Rally
            built: {
                message: {
...
const _StructureDamagedResponseHandler = (snippetName, inVillage, playerBuilt, excludeTags, callback) => {
    ...
    SNIPPET_LocalTimer(debounceTimerName, (payload) => {
        _StructureDamagedResponse(snippetName, payload.ownerVillageId, inVillage, playerBuilt, payload.string, payload.int, excludeTags, payload.float)
    })
}
