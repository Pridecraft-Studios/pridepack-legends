...
const invasionPhaseWeights_Hard = {
    allyPOI: 0.5,
    mountPOI: 0.25,
    towerPOI: 0.4,
    mobAlliances: 1,
...
RegisterDifficultyConfig("invasion_phases_config", phaseValues_Hard, GAME_DIFFICULTY.hard)
RegisterDifficultyConfig("invasion_phases_weights_config", invasionPhaseWeights_Hard, GAME_DIFFICULTY.hard)