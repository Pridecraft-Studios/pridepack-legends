                    ...
                    formationByOrder: [
                        {
                            order: 1,
                            formation: [
                                { action: FACTION_ACTION_ATTACK_VILLAGE_V2, amount: 4 },
                                { action: FACTION_ACTION_ATTACK_VILLAGE_V2_DOUBLE, amount: 2 },
                                { action: FACTION_ACTION_UPGRADE_BASE, amount: 2 },
                    ...
                    formationByOrder: [
                        {
                            ...
                            formation: [
                                ...
                                { action: FACTION_ACTION_ATTACK_VILLAGE_V2_DOUBLE, amount: 3 },
                                { action: FACTION_ACTION_UPGRADE_BASE, amount: 2 },
                                { action: FACTION_ACTION_BUILD_NEAR_BASE, amount: 2 }
                            ]
                        }
