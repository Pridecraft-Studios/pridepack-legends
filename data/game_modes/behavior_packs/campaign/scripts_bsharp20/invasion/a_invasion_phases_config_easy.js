...
const phaseValues = [
    ...
    },
    {
        ...
        conditions: {
            ...
            [TRIGGER_TIME_IMMEDIATE]: TRIGGER_HordeBasesDestroyed(HORDE_ANY, BASE_SIZE_ALL_PORTALS_AND_BOSS_AND_MOB, 8, SNAPSHOT_Act2Started())
        }
    },
    {
        phase: 5,
        conditions: {
            ...
            [TRIGGER_TIME_IMMEDIATE]: TRIGGER_HordeBasesDestroyed(HORDE_ANY, BASE_SIZE_ALL_PORTALS_AND_BOSS_AND_MOB, 10, SNAPSHOT_Act2Started())
        }
    },
    {
        phase: 6,
...
RegisterDifficultyConfig("invasion_phases_config", phaseValues, GAME_DIFFICULTY.easy)
RegisterDifficultyConfig("invasion_phases_weights_config", invasionPhaseWeights, GAME_DIFFICULTY.easy)