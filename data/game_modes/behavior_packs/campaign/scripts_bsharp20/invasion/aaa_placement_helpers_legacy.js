...
const PlaceInvasionClaimedArea = (horde, claimedAreaRadius, numOutposts, placeBase = false, baseSize = null) => {
    ...
    for (const placement of placementTiers) {
        for (let i = 0; i < placement.attempts; i++) {
            ...
            const friendlyVillages = FILTER_ByFactionName(QUERY_GetAllAliveVillages(), [CULTURE_NAME_VILLAGERS, MOB_ALLIANCE_NAME_CREEPER, MOB_ALLIANCE_NAME_SKELETON, MOB_ALLIANCE_NAME_ZOMBIE])
