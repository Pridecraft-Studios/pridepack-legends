...
const InvasionActionsDayPassedCounter = GenericCounter("gv_inv_manager_days_passed", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE, GLOBAL_TRACKER], ALL_INVASION_ACTIONS)
...
const InvasionHordeFirstAttackDelayDays = GenericCounter("gv_invasion_horde_first_attack_delay_days", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
const InvasionHordeFirstAttackStarted = GenericCounter("gv_invasion_horde_first_attack_started", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
...
const VillageAttacksDefendedCounter = GenericCounter("gv_village_attacks_defended", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
...
const HordeOutpostsDestroyedCounter = GenericCounter("gv_outposts_destroyed", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
...
const HordeBasesConstructedCounter = GenericCounter("gv_bases_constructed", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE], [BASE_SIZE_SMALL, BASE_SIZE_MEDIUM, BASE_SIZE_LARGE])
...
const HordeBasesDestroyedCounter = GenericCounter("gv_bases_destroyed", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE], BASE_SIZE_ALL_PORTALS_AND_BOSS_AND_MOB)
...
const HordeBasesUpgradedCounter = GenericCounter("gv_bases_upgraded", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
...
const HordeBasesConstructedAndUpgradedCounter = GenericCounter("gv_bases_constructed_and_upgraded", 0, [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE])
