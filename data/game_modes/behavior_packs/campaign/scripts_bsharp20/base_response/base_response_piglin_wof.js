...
const wofDEAmounts = {
    ...
    //sw
    ["de6"]: { type: wofDE.magmaFoundation, amount: 1 },
    //nw
...
const wofVal = {
    ...
    minionSpawnsT2: [
        ...
        [
            { amount: 1, unit: "badger:piglin_seeker" },
            { amount: 3, unit: "badger:piglin_piggo_warboar" },
    ...
    minionSpawnsT3: [
        ...
        //t3
        [
            { amount: 4, unit: "badger:piglin_grenadier" },
            { amount: 1, unit: "badger:piglin_portal_guard" }
        ],
        [
            { amount: 4, unit: "badger:piglin_bruiser" },
...
const _MakeWOFBase = (_villageId) => {
    ...
    DECK_MultiplyByMultipleRules(northBarracks0, [TagCard("wofNorthBastion")])
    ...
    DECK_MultiplyByMultipleRules(northBarracks1, [TagCard("wofNorthBastion")])
    ...
    DECK_MultiplyByMultipleRules(northEastBarracks0, [TagCard("wofNorthEastBastion")])
    ...
    DECK_MultiplyByMultipleRules(northEastBarracks1, [TagCard("wofNorthEastBastion")])
    ...
    DECK_MultiplyByMultipleRules(eastBarracks0, [TagCard("wofEastBastion")])
    ...
    DECK_PutOnTopOf(eastDraw, eastPrimaryStructures)
    ...
    DECK_MultiplyByMultipleRules(eastBarracks1, [TagCard("wofEastBastion")])
    ...
    DECK_MultiplyByMultipleRules(southEastBarracks0, [TagCard("wofSouthEastBastion")])
    ...
    DECK_MultiplyByMultipleRules(southEastBarracks1, [TagCard("wofSouthEastBastion")])
    ...
    DECK_MultiplyByMultipleRules(southEastBarracks2, [TagCard("wofSouthEastBastion")])
    ...
    DECK_PutOnTopOf(southDraw, southPrimaryStructures)
    ...
    const southBarracks0 = BuildableCard("addSiegerBarracks", 2)
    DECK_MultiplyByMultipleRules(southBarracks0, [TagCard("wofSouthBastion")])
    ...
    DECK_MultiplyByMultipleRules(southWestBarracks0, [TagCard("wofSouthWestBastion")])
    ...
    const southWestBarracks1 = BuildableCard("addSiegerBarracks", 1)
    DECK_MultiplyByMultipleRules(southWestBarracks1, [TagCard("wofSouthWestBastion")])
    ...
    DECK_PutOnTopOf(westDraw, westPrimaryStructures)

    DECK_MultiplyByMultipleRules(westPrimaryStructures, [DistrictCard("wofWestDistrict"), ZoneFilterCard("districtMid"), PlacementPreferenceCard(PLACEMENT_CLOSE_TO_VILLAGE_START), PlacementPreferenceCard("ignoreZoneFilterForOverlappingZones"), TagCard("wofWestBastion"), TagCard("wofBastionBuilding"), AppearanceOverrideCard(BUILDING_APPEARANCE_OVERRIDE_OBSTACLE_HORDE)])
    ...
    DECK_MultiplyByMultipleRules(northWestBarracks0, [TagCard("wofNorthWestBastion")])
    ...
    DECK_MultiplyByMultipleRules(northWestBarracks1, [TagCard("wofNorthWestBastion")])
    ...
    //Spacer loz
    const outerSpacerLOZ = LayerOfZonesCard("addLayerOfZones", 7)
    DECK_MultiplyByMultipleRules(outerSpacerLOZ, [ZoneTagCard("wofDeadZone")])
    //vindicator spawner loz
    const vindicatorLOZ = LayerOfZonesCard("addLayerOfZones", 1)
    DECK_MultiplyByMultipleRules(vindicatorLOZ, [ZoneTagCard("wofVindicatorZone")])
    ...
    //INNER ZONE A
    const innerZoneAPrimary = BuildableCard("piglinTower")
    ...
    //INNER ZONE B
    const innerZoneBPrimary = BuildableCard("piglinTower")
    ...
    //INNER ZONE C
    const innerZoneCPrimary = BuildableCard("piglinTower")
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinKnockbackTower", 1), centerZoneAPrimary)
    DECK_MultiplyByMultipleRules(centerZoneAPrimary, [ZoneFilterCard("centerZoneA"), TagCard("magmaFungiDETag"), PlacementPreferenceCard(PLACEMENT_CLOSE_TO_VILLAGE_START), PlacementPreferenceCard("closeToWater"), TagCard("wofRingBuilding"), AppearanceOverrideCard(BUILDING_APPEARANCE_OVERRIDE_DEFEND_HORDE)])
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinTower", 3), centerZoneATertiary)
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinShieldTower"), centerZoneBPrimary)
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinKnockbackTower"), centerZoneBSecondary)
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinTower", 3), centerZoneBTertiary)
    DECK_MultiplyByMultipleRules(centerZoneBTertiary, [ZoneFilterCard("centerZoneB"), PlacementPreferenceCard("placeRandomly"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), TagCard("wofRingBuilding"), AppearanceOverrideCard(BUILDING_APPEARANCE_OVERRIDE_ATTACK_HORDE)])
    ...
    DECK_MultiplyByMultipleRules(centerZoneCPrimary, [ZoneFilterCard("centerZoneC"), TagCard("magmaShieldDETag"), PlacementPreferenceCard(PLACEMENT_CLOSE_TO_VILLAGE_START), PlacementPreferenceCard("closeToWater"), TagCard("wofRingBuilding"), AppearanceOverrideCard(BUILDING_APPEARANCE_OVERRIDE_OBSTACLE_HORDE)])
    DECK_PutOnBottomOf(centerZoneCPrimary, baseDeck)

    const centerZoneCSecondary = DECK_Empty()
    DECK_PutOnBottomOf(BuildableCard("piglinShieldTower"), centerZoneCSecondary)
    DECK_MultiplyByMultipleRules(centerZoneCSecondary, [ZoneFilterCard("centerZoneC"), PlacementPreferenceCard("placeRandomly"), PlacementPreferenceCard(PLACEMENT_CLOSE_TO_VILLAGE_START), PlacementPreferenceCard("closeToWater"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), TagCard("wofRingBuilding"), AppearanceOverrideCard(BUILDING_APPEARANCE_OVERRIDE_OBSTACLE_HORDE)])
    ...
    DECK_PutOnBottomOf(BuildableCard("piglinTower", 3), centerZoneCTertiary)
    ...
    DECK_MultiplyByMultipleRules(vindicatorNorth, [ZoneFilterCard("wofVindicatorZone"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), PlacementPreferenceCard("placeInDirectionNorthWithWedgeBrush"), PlacementPreferenceCard("placeFarFromVindicatorBarracks")])

    const vindicatorEast = BuildableCard("wofVindicatorSpawner", 4)
    DECK_MultiplyByMultipleRules(vindicatorEast, [ZoneFilterCard("wofVindicatorZone"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), PlacementPreferenceCard("placeInDirectionEastWithWedgeBrush"), PlacementPreferenceCard("placeFarFromVindicatorBarracks")])

    const vindicatorSouth = BuildableCard("wofVindicatorSpawner", 4)
    DECK_MultiplyByMultipleRules(vindicatorSouth, [ZoneFilterCard("wofVindicatorZone"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), PlacementPreferenceCard("placeInDirectionSouthWithWedgeBrush"), PlacementPreferenceCard("placeFarFromVindicatorBarracks")])

    const vindicatorWest = BuildableCard("wofVindicatorSpawner", 4)
    DECK_MultiplyByMultipleRules(vindicatorWest, [ZoneFilterCard("wofVindicatorZone"), PlacementPreferenceCard(PLACEMENT_FAR_FROM_VILLAGE_START), PlacementPreferenceCard("placeInDirectionWestWithWedgeBrush"), PlacementPreferenceCard("placeFarFromVindicatorBarracks")])
...
SNIPPET_VillageGenerated("vg_wof", (villageId) => {
    ...
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_FIGHTER, FighterBarracksConfig_WOFFaction, 0)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_DISRUPTOR, DisruptorBarracksConfig_WOFFaction, 0)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_SIEGER, SiegerBarracksConfig_WOFFaction, 0)
    SetEscalationValueAndUpdateBarracksForVillageVariation(villageId, BARRACKS_NAME_VINDICATORS, VindicatorBarracksConfig_wofFaction, 0)
...
SNIPPET_EntitySpawned("es_wof_boss_spawned", (bossEntity, payload) => {
    ...
    if (QUERY_HasLeash(bossLeash)) {
        ...
        OUTPUT_SetLeash(bossLeash, wofLeash, 90, 30)
    } else {
        OUTPUT_SetLeash(bossLeash, wofLeash, 90, 30)
    }
...
SNIPPET_LocalTimer("lt_wof_reset_outer_boss_mob_spawn", (payload) => {
    ...
    const villageId = payload.ownerVillageId
    const axeSpawnsCount = QUERY_GetEntitiesWithTags("axeSpawns")
    ...
    let chosenSpawn = []
    if (IsBaseEscalated(baseEntity, wofVal.escalation.innerWallDestroyed)) {
    ...
    } else if (IsBaseEscalated(baseEntity, wofVal.escalation.portalApproached)) {
    ...
    if (chosenSpawn.length > 0) {
        for (const unitEntry of chosenSpawn) {
            ...
            if (HasEntities(rallyPoint)) {
                OUTPUT_AssignToControlGroup(newSpawns, rallyPoint)
                OUTPUT_AddTag(newSpawns, "hasControlGroup")
                OUTPUT_MoveAttackEntity(newSpawns, rallyPoint, CALLBACK_NONE)
                DistributeUnitsToAI(newSpawns, [[finalAi.siege, 100]], wofVal.aiConfig)
            }
        }
    }
...
SNIPPET_SpatialPartitionEntered("spe_attack_cine_wof", (triggerEntity, intruderEntity) => {
    ...
    // BARRACKS ============================================================================================================================================================
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_FIGHTER, FighterBarracksConfig_WOFFaction, 1)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_DISRUPTOR, DisruptorBarracksConfig_WOFFaction, 1)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_SIEGER, SiegerBarracksConfig_WOFFaction, 1)
    SetEscalationValueAndUpdateBarracksForVillageVariation(villageId, BARRACKS_NAME_VINDICATORS, VindicatorBarracksConfig_wofFaction, 1)
...
SNIPPET_NonPopCappedEntityDestroyed("ed_wof_wall_destroyed", (destroyedEntity, payload) => {
    ...
    // BARRACKS ============================================================================================================================================================
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_FIGHTER, FighterBarracksConfig_WOFFaction, 2)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_DISRUPTOR, DisruptorBarracksConfig_WOFFaction, 2)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_SIEGER, SiegerBarracksConfig_WOFFaction, 2)
...
SNIPPET_NonPopCappedEntityDestroyed("ed_wof_key_building", (destroyedEntity) => {
    ...
    // BARRACKS ============================================================================================================================================================
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_FIGHTER, FighterBarracksConfig_WOFFaction, 3)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_DISRUPTOR, DisruptorBarracksConfig_WOFFaction, 3)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_SIEGER, SiegerBarracksConfig_WOFFaction, 3)
...
SNIPPET_NonPopCappedEntityDestroyed("ed_wof_inner_walls_destroyed", (destroyedEntity, payload) => {
    ...
    // BARRACKS ============================================================================================================================================================
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_FIGHTER, FighterBarracksConfig_WOFFaction, 4)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_DISRUPTOR, DisruptorBarracksConfig_WOFFaction, 4)
    SetEscalationValueAndUpdateBarracksForVillage(villageId, BARRACKS_NAME_SIEGER, SiegerBarracksConfig_WOFFaction, 4)

    // AUDIO  =======================================================================================================================================================
    PlayPresentationActionToAll(wofVal.VO.wofEscalation4)
