...
const GetOutpostDifficultyFromPhase = () => {
    const phase = GetInvasionPhase()
    return phase <= 3 ? 1 : phase <= 5 ? 2 : 3 //Return 1/2/3
}
...
const HandleFreeingMobsFromCagesAfterDestroyingVillage = (villageId) => {
    ...
    const cagedVillagers = FILTER_ByTagFilter(villageEntities, ["caged_mob", "villager"], [])
    const cagedMobs = FILTER_ByTagFilter(villageEntities, ["caged_mob", "allied_mob"], [])
