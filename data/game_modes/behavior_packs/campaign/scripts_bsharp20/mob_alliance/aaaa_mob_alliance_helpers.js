...
const mobAllianceOccupationOrder = [{ type: "fixed", mobAllianceId: "skeleton" }, { type: "random" }, { type: "random" }]
...
const IsMobAlliancePiglinSize = (size) => {
    return size === BASE_SIZE_PIGLIN_ZOMBIE || size === BASE_SIZE_PIGLIN_CREEPER || size === BASE_SIZE_PIGLIN_SKELETON
}
...
const UnlockMobAlliance = (modId) => {
    ...
    OUTPUT_AddOrRemoveTeamResource(TEAM_BLUE, mobAllianceData.unlocks.battleView, 1, false)
